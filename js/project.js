...
if (!p) {
  root.innerHTML = `
    <div class="proj-404">
      ...
      <a href="index.html#work" class="btn-primary">← Back to all work</a>
    </div>`;
} else {
    ...
    '@graph': [
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Work', item: 'https://ivorystudios.io/work.html' },
  ...
  root.innerHTML = `
    <header class="proj-hero">
      ...
      <div class="container proj-hero-inner">
        <a href="index.html#work" class="proj-back">← All Work</a>
    ...
    <section class="proj-next dark-section">
      <div class="container proj-next-inner">
        ...
        <a href="index.html#contact" class="btn-primary magnetic"
